<div class="container-fluid p-0 m-0" id="strong">
  <div class="attendance-training-tabs">
    <div class="attendance-training-tab active" id="attendance-tab" onclick="showTab('attendance')">Attendance</div>
    <div class="attendance-training-tab" id="training-tab" onclick="showTab('training')">Training</div>
  </div>

  <!-- Attendance Tab Content -->
  <div class="attendance-tab-content active" id="attendance-content">
    <div class="attendance-training-dropdown"></div>

    <!-- Attendance Records in Card Layout -->
    <div class="attendance-training-table">
      <div id="attendance-body">
        <!-- Attendance Cards will be dynamically inserted here -->
      </div>
    </div>
  </div>

  <!-- Training Tab Content -->
  <div class="training-tab-content" id="training-content">
...
<script>
  function showTab(tab) {
    if (tab === "attendance") {
      document.getElementById("attendance-content").classList.add("active");
      ...
      document.getElementById("training-tab").classList.remove("active");
    } else {
      document.getElementById("attendance-content").classList.remove("active");
